        ...
        <SafeAreaContainerView>
            <ScrollView style={{ width: '100%', height: 700, marginBottom: 140 }}>
                ...
                <View
                    ...
                    <Text style={{ color: '#000', fontSize: 17 }}> Share the story... </Text>
                </View>
                <View style={{ marginTop: 40, paddingLeft: 10 }}>
                    <Text style={{ color: '#000', fontSize: 20, fontWeight: '600' }}> 10 May 2021 </Text>
                </View>
                <View style={{...globalStyles.flexColView, gap: 15, marginTop: 20}}>
                    <View style={{...globalStyles.flexRowView, justifyContent: 'space-between', paddingLeft: 18, paddingRight: 25}}>
                ...
                <View style={{...globalStyles.flexRowView, justifyContent: 'space-between', paddingLeft: 20, paddingRight: 30, marginTop: 40}}>
                    <Text style={localStyles.textStyle}> Location </Text>
                    <TouchableOpacity style={{ borderWidth: 1.5, borderColor: 'gray', paddingHorizontal: 50, paddingVertical: 5 }}>
