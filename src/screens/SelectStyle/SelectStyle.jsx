...
import { View, Image, ScrollView, Text, TouchableOpacity, FlatList, StyleSheet } from "react-native";
...
export const SelectStyleScreen = ({ navigation, route })=> {
    ...
    return (
        <SafeAreaContainerView>
            <ScrollView style={{ width: '100%', height: SCREEN_HEIGHT, backgroundColor: '#000' }}>
                <View
                    style={{
                ...
                >
                    ...
                    <Icon size={28} color={'white'} name="auto-fix" />

                    <TouchableOpacity>
                        <Text style={{ fontSize: 16, color: '#1e7fc9', fontWeight: '600' }}> Next </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', paddingTop: 85 }}>
