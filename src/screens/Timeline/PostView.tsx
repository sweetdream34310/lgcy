    ...
    return (
        <SafeAreaContainerView>
            <ScrollView style={{ width: '100%', height: 700, marginBottom: 70 }}>
                <View style={{ ...globalStyles.flexRowView, justifyContent: 'space-between', paddingLeft: 5, paddingRight: 20, marginTop: 10 }}>
                    <TouchableOpacity
                ...
                >
                    ...
                    <View style={{ ...globalStyles.flexColView, alignItems: 'flex-start', marginTop: 5 }}>
                        <TouchableOpacity onPress={() => navigation.navigate('CommentsView')}>
                            <Text style={{ fontSize: 15 }}> 10 Comments </Text>
                        </TouchableOpacity>
                        <View style={{ ...globalStyles.flexRowView, justifyContent: 'flex-start', marginTop: 5 }}>
                            <Text style={{ color: '#000', fontWeight: '500', fontSize: 16 }}> April 30, 2021&nbsp;&nbsp; </Text>
                            <Text style={{ color: '#000', fontWeight: '600', fontSize: 18 }}> Vebuce Beach, United States </Text>
                        </View>
                    </View>
                </View>
