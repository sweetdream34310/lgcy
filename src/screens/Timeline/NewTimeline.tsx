        ...
        <SafeAreaContainerView>
            <ScrollView style={{ width: '100%', height: 700, marginBottom: 140 }}>
                ...
                <View style={{ ...globalStyles.flexColView, marginTop: 50 }}>
                    <View style={{ ...globalStyles.flexColView, alignItems: 'flex-start', width: '70%' }}>
                    ...
                    <View style={{ ...globalStyles.flexColView, alignItems: 'flex-start', width: '70%', marginTop: 30 }}>
                    ...
                    <View style={{ marginTop: 30, position: 'relative' }}>
                        ...
                        <Image
                            ...
                            style={{ position: 'absolute', top: -5, left: 80, width: 25, height: 25 }}
                        />
                    </View>
                    <View style={{...globalStyles.flexRowView, justifyContent: 'space-evenly', marginTop: 30}}>
                    ...
                    <View style={{...globalStyles.flexColView, gap: 30, marginTop: 30}}>
                        <TouchableOpacity style={localStyles.timelineButton}>
                            <Text style={localStyles.timelineButtonText}> Invite Members </Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={localStyles.timelineButton}>
                            <Text style={localStyles.timelineButtonText}> Create Timeline </Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
